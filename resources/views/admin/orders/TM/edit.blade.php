@extends('layouts.app', ['title' => 'Edit Order', 'cat_name' => 'trademark', 'page_name' => 'manage_orders'])
...
@section('content')
    ...
    <div class="row layout-top-spacing" id="cancel-row">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="statbox widget box box-shadow">
                <div class="widget-header">
                    <form action="{{ url('/tm_update-order') }}" method="POST" enctype="multipart/form-data">
                        @csrf
