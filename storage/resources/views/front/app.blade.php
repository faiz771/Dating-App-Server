...
// $(document).on('click', '.terms_condition_accept', function(){
...
// $(document).on('click', '.agree_enabled', function(){
//     $('.accept_terms_conditions').hide();
//     $('.ein_confirm_next_button').show();
// });
...
$(document).on('click', '.terms_condition_accept', function(){
    var check = $(this).is(':checked');
     if(check == true){
        $('.ein_confirm_next_button').show();
    $('.accept_terms_conditions_disable').hide();
     }else{
        $('.ein_confirm_next_button').hide();
    $('.accept_terms_conditions_disable').show();
     }
...
$('.company_name').on('keyup',function(){
    ...
    $('.pc_confirm').html(company_name);
})


$(document).on('click', '.accept_terms_conditions', function(){
