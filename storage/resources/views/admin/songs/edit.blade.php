...
@extends('layouts.app', ['title' => 'Edit Song','cat_name'=>'Songs','page_name'=>'edit_Song'])
...
@section('content')
    ...
    <div class="row layout-top-spacing" id="cancel-row">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="statbox widget box box-shadow">
                <div class="widget-header">
                    <form action="{{ url('/save-songs') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <input type="hidden" name="ext_img" value="{{ $song->image }}">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="inputAddress">Songs</label>
                                <input oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "25" type = "number" maxlength = "25" class="form-control" id="inputAddress" name="song"
                                    placeholder="Song" value="{{ $song->price }}">
                            </div>
