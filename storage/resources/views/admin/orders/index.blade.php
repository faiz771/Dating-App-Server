@extends('layouts.app', ['title' => 'Orders', 'cat_name' => 'orders', 'page_name' => 'manage_orders'])
                ...
                <div class="widget-header">
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-md-6 col-sm-6 col-6 d-flex justify-content-end">
                            <form method="POST" action="{{url('/order_filter_byStatus')}}" id="formformeal" enctype="multipart/form-data" style="display: flex;width: 70%;">
                                @csrf
                                <input type="hidden" name="ser" value="pkg">
                                    ...
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <div class="dropdown-menu left" aria-labelledby="pendingTask" style="will-change: transform; position: absolute; transform: translate3d(105px, 0, 0px); top: 0px; left: 0px;">
                                           ...
                                           <a class="dropdown-item assign_coupon_detail" href="javascript:void(0);" data-id="{{$val->id}}"><i data-feather="info"></i> Assign Coupon</a>
                                            ...
                                            @elseif(strtoupper($val->status) == 'REFUND')    
                                            <a href="javascript:void(0)" class="dropdown-item refunded" data-id="{{$val->id}}" data-text="
                                                @if(!empty($val->coupon_id))
                                                  {{$val->before_assign_coupon_amount}}
                                                @else
                                                  {{ $val->amount }}
        ...
        <form action="{{url('/assign_coupon')}}" method="POST">
          ...
          <div class="modal-body">
            <div class="form-group">
                ...
                <input type="hidden" class="form-control" name="type" id="" aria-describedby="" value="LLC">
